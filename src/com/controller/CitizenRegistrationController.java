...
/**
 * Servlet implementation class CitizenRegistrationController
 */
@WebServlet("/CitizenRegistrationController")
public class CitizenRegistrationController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (dao.InsertCitizenData(b)) {
			...
			out.println("location='CitizenRegistration.jsp';");
			out.println("</script>");
		}
	}
