      ...
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto " href="CitizenLogin.jsp">Citizen</a></li>
            <li><a class="nav-link scrollto active" href="PoliceLogin.jsp">Police</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="section-title">
              ...
              <p>Police can Register here...</p>
            </div>
          </div>

          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
           
            <form action="PoliceRegistrationController" method="post" role="form" class="form1">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" pattern="[A-Za-z]+" required>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="mobileno" id="mobileno" placeholder="Your mobileno" pattern="[7-9]{1}[0-9]{9}" required>
                </div>
              </div>
               <div class="row">
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="password" class="form-control" name="password" id="password" placeholder="Password(e.g. Abc@1234)" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required>
                </div>
              </div>
               <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="uid" class="form-control" id="uid" placeholder="Your UID" required>
                </div>
              </div>
              <br>
              <div class="text-center"><button type="submit">Register</button>
              <br>
              <a href="PoliceLogin.jsp" style="color:red;">Login here...</a>
              </div>
            </form>
          </div>
        </div>
