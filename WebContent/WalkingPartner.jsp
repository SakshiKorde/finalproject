            ...
            <div class="row">
              <div class="col-md-2 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                  ...
                  <h4><a href="AddWalkingPartner.jsp">Add Walking</a></h4>
                  <p></p>
                </div>
              </div>
              ...
              <div class="col-md-2 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                  ...
                  <h4><a href="ViewWalkingPartner.jsp">View Walking Partner</a></h4>
                  <p></p>
                </div>
              </div>
              ...
              <div class="col-md-2 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                  <div class="icon"><i class="bx bx-walk"></i></div>
                  <h4><a href="ViewWalkingRequest.jsp">View Walking Request</a></h4>
                  <p></p>
                </div>
              </div>
               ...
               <div class="col-md-2 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                  <div class="icon"><i class="bx bx-walk"></i></div>
                  <h4><a href="ViewWalkingTogether.jsp">Walking Together</a></h4>
                  <p></p>
                </div>
              </div>
