        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="section-title">
              <h2>Police Login</h2>
              <p>Police can login here...</p>
            </div>
          </div>

          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
           
            <form action="PoliceLoginController" method="post" role="form" class="form1">
              <div class="row">
              ...
              <br>
              <a href="PoliceRegistration.jsp" style="color:red;">Register here...</a>
              </div>
            </form>
          </div>
        </div>
