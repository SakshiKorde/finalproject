     ...
     <br><br> <br><br>
      <div class="container">
       <div class="section-title">
          <h2 style="font-size:22px;"><span>Walking</span> Together</h2>
				...
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     /* HttpSession ss=request.getSession();
          			String partnername=(String)ss.getAttribute("partnername"); */
                    /*  String partnername=request.getParameter("partnername");  */
                     Connection con=DBConnection.getConnection();
                     Statement st=con.createStatement();
                     ResultSet rs=st.executeQuery("select * from joinpartner");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No Request Present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
                    	...
                    	<%-- <th><a style="color:#2eca6a;" href="UpdateWalkingRequestStatusCon?id=<%=rs.getInt(1)%>&status=<%=rs.getString(6)%>"><%=rs.getString(6)%></a></th>
                    	 --%>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
