      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="ChengePwdController" method="post" role="form" class="form1">
              <div class="row">
              
                <div class="col-md-6 form-group">
                  <input type="password" name="oldpass" class="form-control" id="oldpass" placeholder="Enter Password" required>
                </div>
                <div class="col-md-6 form-group">
                  <input type="password" name="newpass" class="form-control" id="newpass" placeholder="Your New password" required>
                </div>
