    ...
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
         ...
         <!--   <li><a class="nav-link scrollto" href="ViewCitizen.jsp">View Citizen</a></li>
           <li><a class="nav-link scrollto" href="ViewPolice.jsp">View Police</a></li>
           <li><a class="nav-link scrollto " href="ViewFeedback.jsp">View Feedback</a></li> -->
            <li class="dropdown"><a href="#"><span>Welcome Admin</span> <i class="bi bi-chevron-right"></i></a>
                  <ul>
            ...
            <div class="row">
              ...
              <div class="col-md-2 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                  ...
                  <h4><a href="ViewCitizen.jsp">View Citizen</a></h4>
                  <p></p>
                </div>
              </div>
              ...
              <div class="col-md-2 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                  ...
                  <h4><a href="ViewPolice.jsp">View Police</a></h4>
                  <p></p>
                </div>
              </div>
              ...
              <div class="col-md-2 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
                  ...
                  <h4><a href="ViewFeedback.jsp">View Feedback</a></h4>
                  <p></p>
                </div>
              </div>
             <!--  <div class="col-md-2 d-flex align-items-stretch">
