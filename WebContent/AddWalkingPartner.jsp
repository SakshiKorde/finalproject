      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="WalkingPartnerController" method="post" role="form" class="form1">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" value="${name }" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="area" id="area" placeholder="Your Walking Area" required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="location" class="form-control" id="location" placeholder="Add Your Location" required>
                </div>
              </div>
