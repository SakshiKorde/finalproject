     ...
     <br><br> <br><br>
      <div class="container">
       <div class="section-title">
          <h2 style="font-size:22px;"><span>View</span> Spot Crime</h2>
			...
			<div class="container">  -->
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from spotcrime");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	do{	 
                    	 ...
                    	 <tr  class="danger" style="color:black">
		                  ...
		                  <%}%>
                    	 <TR>
                    	  <td><img alt="Profile Pic" class="img-circle" src="SpotCrimePic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td>
                    	
                    	  <td style="color:black"><%=rs.getString(3) %></td>
                    	   <td style="color:black"><%=rs.getString(4) %></td>
                    	    <td style="color:black"><%=rs.getString(5) %></td>
                    	     <td style="color:black"><a href="<%=rs.getString(8) %>">Click here</a></td>
                    	      <td style="color:black"><%=rs.getString(9) %></td>
                    	      <td><a href="DeleteSpotCrimeCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
