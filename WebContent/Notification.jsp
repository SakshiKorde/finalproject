      ...
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="ViewEvidence.jsp">View Evidence</a></li>
            <li><a class="nav-link scrollto active" href="Notification.jsp">Notification</a></li>
     ...
     <br><br> <br><br>
      <div class="container">
         ...
         <div class="section-title">
          <h2 style="font-size:22px;"><span>Alert Message</span>  </h2>
