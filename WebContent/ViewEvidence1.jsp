     ...
     <br><br> <br><br>
      <div class="container">
       <div class="section-title">
          <h2 style="font-size:22px;"><span>View</span> Evidence</h2>
			...
			<div class="container">  -->
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from evidence where name='"+name+"'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No Evidence Present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
                    	do{	 
                    	 ...
                    	 <th>Evidence</th>
		                  ...
		                  <%}%>
                    	 <TR>
                    	  <td><img alt="Profile Pic" class="img-circle" src="EvidencePic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td>
