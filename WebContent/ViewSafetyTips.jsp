     ...
     <br><br> <br><br>
      <div class="container">
       <div class="section-title">
          <h2 style="font-size:22px;"><span>View</span> Safety Tips </h2>
			...
			<div class="container">  -->
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from safetytips");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	do{	 
                    	 ...
                    	 <TR>
                    	  ...
                    	  <td style="color:black"><a href="<%=rs.getString(3) %>">Click here</a></td>
                    	   <td><a href="DeleteSaftyTipCon?id=<%=rs.getInt(1)%>" style="color:red;"><b>Delete</b></a></td> 
