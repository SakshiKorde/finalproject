      ...
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
           ...
           <li><a class="nav-link scrollto active" href="ShareGPSLocationCitizen.jsp">Share GPS Location</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="ShareGPSLocationCitizenController" method="post" role="form" class="form1">
              <div class="row">
               ...
               <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="location" class="form-control" id="location" placeholder="Your location Link" required>
                </div>
