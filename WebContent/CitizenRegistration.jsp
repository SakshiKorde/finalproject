        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="section-title">
              ...
              <p>Citizen's can Register here...</p>
            </div>
          </div>

          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
           
            <form action="CitizenRegistrationController" method="post" role="form" class="form1">
              <div class="row">
              ...
              <div class="row">
               ...
               <div class="row">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="password" class="form-control" name="password" id="password" placeholder="Password(e.g. Abc@123)" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required>
                </div>
              </div>
              <br>
              <div class="text-center"><button type="submit" >Register</button>
              <br>
              <a href="CitizenLogin.jsp" style="color:red;">Login here...</a>
              </div>
            </form>
          </div>
        </div>
