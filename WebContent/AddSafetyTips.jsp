      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="AddSafetyTipsController" method="post" role="form" class="form1">
              <div class="row">
                <div class="col-md-12 form-group">
                  <textarea name="safetytips" class="form-control" id="safetytips" placeholder="Add Safety Tips" required></textarea>
                </div>
                <div class="col-md-12 form-group">
                  <textarea name="video" class="form-control" id="video" placeholder="Add Video Link" required></textarea>
                </div>
