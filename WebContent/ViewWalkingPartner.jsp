     ...
     <br><br> <br><br>
      <div class="container">
       <div class="section-title">
          <h2 style="font-size:22px;"><span>View</span> Walking Partner </h2>
			...
			<div class="container">  -->
				<div class="row">
                    ...
                    /*  HttpSession ss=request.getSession();
                     ...
                     ResultSet rs=st.executeQuery("select * from walkingpartner");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	do{	 
                    	 ...
                    	 <TR>
                    	  ...
                    	  <td style="color:black"><a href="<%=rs.getString(4) %>">View Walking Location</a></td>
                    	<td style="color:black"><a href="JoinPartner.jsp?id=<%=rs.getInt(1) %>">Join Walk</a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
